...
class UI(BusNode):
	...
	def __init__(self, eventBus):
		...
		self.fileMenu.add_command(label="New Sim")
		...
		self.PlayButton = Button(self.PlayPauseFrame, bg = 'green', bd = 1)
		self.PlayButton.place(relheight = 0.95, relwidth = 0.40, relx = 0.05)

		self.PauseButton = Button(self.PlayPauseFrame, bg = 'red', bd = 1)
